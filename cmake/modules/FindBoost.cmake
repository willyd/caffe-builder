...
#-------------------------------------------------------------------------------
# Default set the appropriate variables according to our build 
# settings
message(STATUS "Using custom FindBoost module")
...
set(Boost_USE_MULTITHREADED ON)
set(Boost_USE_STATIC_RUNTIME OFF)
get_filename_component(BOOST_ROOT ${CMAKE_CURRENT_LIST_DIR}/../boost ABSOLUTE)
#-------------------------------------------------------------------------------
...
set(Boost_LIBRARIES )
foreach(c ${_Boost_COMPONENTS_SEARCHED})
